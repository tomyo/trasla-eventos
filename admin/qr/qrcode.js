 ...
 *
 * https://github.com/locandy/qrcodejs/blob/master/README.md
 *
 * @author davidshimjs
...
(function () {
  ...
  var canvasDrawer = (function () {
    ...
    Drawing.prototype.draw = function (oQRCode) {
      ...
      _oContext.fillRect(
        _htOption.width - nBorderWidth,
        nBorderHeight,
        _htOption.width,
        _htOption.height - nBorderHeight
      );
  ...
  QRCode = function (el, vOption) {
    ...
    if (this._htOption.useSVG) this._htOption.output = "svg";
