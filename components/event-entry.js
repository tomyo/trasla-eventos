...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    renderButtons() {
      ...
      htmlString += /*html*/ `
        <share-url data-action="share" data-fallback-action="clipboard" data-text-success="Compartido" data-text-success-fallback="Link copiado" data-url="${shareUrl}" data-title="${this.dataset.title}">
